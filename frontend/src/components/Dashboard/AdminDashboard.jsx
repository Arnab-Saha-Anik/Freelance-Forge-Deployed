...
const AdminDashboard = () => {
  ...
  const fetchUsers = async () => {
    ...
    try {
      const response = await fetch("https://freelance-forge-deployed.onrender.com/users", {
        headers: {
  ...
  const handleDeleteUser = async (userId) => {
    ...
    if (window.confirm("Are you sure you want to delete this user?")) {
      try {
        const response = await fetch(`https://freelance-forge-deployed.onrender.com/users/admin/${userId}`, {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const handleDeleteProject = async (projectId) => {
    ...
    if (window.confirm("Are you sure you want to delete this project?")) {
      try {
        const response = await fetch(`https://freelance-forge-deployed.onrender.com/projects/admin/${projectId}`, {
          method: "DELETE",
        });
        if (response.ok) {
  ...
  const handleDeleteMaterial = async (materialId) => {
    if (window.confirm("Are you sure you want to delete this learning material?")) {
      try {
        const response = await fetch(`https://freelance-forge-deployed.onrender.com/learning-materials/${materialId}`, {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${token}`,
          },
