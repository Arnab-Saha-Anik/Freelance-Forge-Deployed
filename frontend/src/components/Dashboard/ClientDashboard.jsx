...
const ClientDashboard = () => {
  ...
  const checkUserExists = useCallback(async () => {
    try {
      const response = await fetch(`https://freelance-forge-deployed.onrender.com/users/check/${loggedInClientId}`, {
        headers: {
  ...
  const fetchProjects = useCallback(async () => {
    ...
    try {
      const response = await fetch("https://freelance-forge-deployed.onrender.com/projects/client/projects", {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  const fetchFreelancers = useCallback(async () => {
    ...
    try {
      const response = await fetch("https://freelance-forge-deployed.onrender.com/users/allfreelancers");
      const data = await response.json();
      ...
      const freelancersWithReviewInfo = await Promise.all(
        Array.isArray(data) ? data.map(async (freelancer) => {
          try {
            ...
            const reviewsResponse = await fetch(`https://freelance-forge-deployed.onrender.com/reviews/received/${freelancer._id}`, {
              headers: {
                Authorization: `Bearer ${token}`,
              },
            });
  ...
  const fetchMyReviews = useCallback(async () => {
    try {
      const response = await fetch(`https://freelance-forge-deployed.onrender.com/reviews/received/${loggedInClientId}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  const fetchFreelancerReviews = useCallback(async (freelancerId, freelancerName) => {
    try {
      const response = await fetch(`https://freelance-forge-deployed.onrender.com/reviews/received/${freelancerId}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  const markNotificationsAsRead = async () => {
    try {
      const response = await fetch("https://freelance-forge-deployed.onrender.com/notifications/mark-as-read", {
        method: "PUT",
        headers: {
          Authorization: `Bearer ${token}`,
        },
  ...
  const handleProjectSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://freelance-forge-deployed.onrender.com/projects/create", {
        method: "POST",
        headers: {
  ...
  const handleAccountUpdate = async (e) => {
    ...
    try {
      const response = await fetch(`https://freelance-forge-deployed.onrender.com/users/client/update`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
      ...
      if (response.ok) {
        ...
        const userResponse = await fetch(`https://freelance-forge-deployed.onrender.com/users/me`, {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        });
  ...
  const handleDeleteAccount = async (e) => {
    ...
    try {
      const response = await fetch("https://freelance-forge-deployed.onrender.com/users/client/delete", {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
  ...
  const handleDeleteProject = async (projectId) => {
    ...
    try {
      const response = await fetch(`https://freelance-forge-deployed.onrender.com/projects/client/delete/${projectId}`, {
        method: "DELETE",
        headers: {
          Authorization: `Bearer ${token}`,
        },
  ...
  const handleRefundEscrow = async (projectId) => {
    try {
      const response = await fetch(`https://freelance-forge-deployed.onrender.com/payments/refund-escrow/${projectId}`, {
        method: "POST",
        headers: {
  ...
  const handleDirectHire = async (projectId) => {
    try {
      const response = await fetch("https://freelance-forge-deployed.onrender.com/direct-hire", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
  ...
  const fetchBidsForProject = async (projectId, projectTitle) => {
    try {
      const response = await fetch(`https://freelance-forge-deployed.onrender.com/bids/${projectId}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  const handleSelectBid = async (bidId) => {
    ...
    try {
      const response = await fetch(`https://freelance-forge-deployed.onrender.com/bids/select/${bidId}`, {
        method: "PUT",
        headers: {
          Authorization: `Bearer ${token}`,
        },
  ...
  const handlePaymentSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`https://freelance-forge-deployed.onrender.com/payments/create-payment-intent`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${localStorage.getItem("clientToken")}`,
  ...
  const handleApproveProject = async (projectId) => {
    try {
      const response = await fetch(`https://freelance-forge-deployed.onrender.com/projects/approve-completion/${projectId}`, {
        method: "PUT",
        headers: {
          Authorization: `Bearer ${localStorage.getItem("clientToken")}`,
        },
  ...
  const handleRejectApproval = async (projectId, comments) => {
    try {
      const response = await fetch(`https://freelance-forge-deployed.onrender.com/projects/reject-approval/${projectId}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${localStorage.getItem("clientToken")}`,
  ...
  const handleEditProjectSubmit = async (updatedProject) => {
    try {
      const response = await fetch(`https://freelance-forge-deployed.onrender.com/projects/client/update/${updatedProject.id}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
                          ...
                          onClick={async () => {
                            try {
                              const response = await fetch(
                                `https://freelance-forge-deployed.onrender.com/payments/claim-remaining/${project._id}`,
                                {
                                  method: "POST",
                                  headers: {
                                    "Content-Type": "application/json",
