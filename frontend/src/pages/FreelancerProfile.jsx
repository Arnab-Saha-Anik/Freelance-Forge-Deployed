...
const FreelancerProfile = () => {
    ...
    const fetchProfileData = async () => {
      ...
      try {
        ...
        const [profileExistenceResponse, freelancerResponse, userResponse] = await Promise.all([
          fetch(`https://freelance-forge-deployed.onrender.com/freelancers/check/${userId}`, {
            headers: {
              Authorization: `Bearer ${token}`,
            },
          }),
          fetch(`https://freelance-forge-deployed.onrender.com/freelancers/${userId}`, {
            headers: {
              Authorization: `Bearer ${token}`,
            },
          }),
          fetch(`https://freelance-forge-deployed.onrender.com/users/me`, {
            headers: {
              Authorization: `Bearer ${token}`,
            },
          }),
  ...
  const handleFreelancerInfoSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`https://freelance-forge-deployed.onrender.com/freelancers/${userId}`, {
        method: "PUT",
        headers: {
  ...
  const handleCreateFreelancerProfile = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`https://freelance-forge-deployed.onrender.com/freelancers`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
  ...
  const handleUserInfoSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch(`https://freelance-forge-deployed.onrender.com/users/update`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
  ...
  const handleAccountDelete = async (e) => {
    ...
    try {
      const validateResponse = await fetch(`https://freelance-forge-deployed.onrender.com/users/validate`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
    ...
    try {
      const response = await fetch(`https://freelance-forge-deployed.onrender.com/users/delete`, {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
