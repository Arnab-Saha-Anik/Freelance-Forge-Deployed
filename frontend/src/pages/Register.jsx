...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const emailCheckResponse = await axios.post("https://freelance-forge-deployed.onrender.com/users/check-email", { email });
      ...
      await axios.post("https://freelance-forge-deployed.onrender.com/users/register", {
        name: fullName,
        email,
        password,
        role,
